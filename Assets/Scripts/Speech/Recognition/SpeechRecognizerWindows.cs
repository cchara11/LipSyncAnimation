...
public class SpeechRecognizerWindows : MonoBehaviour {
    ...
    void Start () {
        ...
        {
            if (s.Equals("Microphone (C922 Pro Stream Webcam)"))
            {
                Microphone.Start(s, true, 500, 40000);
            }
    ...
    private void KeywordRecognizer_OnPhraseRecognized(PhraseRecognizedEventArgs args)
    {
        ...
        Debug.Log(args.semanticMeanings);
